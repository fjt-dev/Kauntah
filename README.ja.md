...
- `npm run dev -- --local`を起動後、別のターミナルで`npm run test:integration`: レスポンスとデザインごとのキャッシュ分離を検証します。
...
- **アニメーション素材**: [Moe-Counter](https://github.com/journey-ad/Moe-Counter) (`rule34`); [source and license](./assets/rule34/README.md).
